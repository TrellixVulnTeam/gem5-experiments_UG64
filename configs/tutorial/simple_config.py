...
#Now that the mem bus is created we connect the cache ports of the CPU to it
#The TimingSimpleCPU does not have any caches
#We connect I-caches and D-cache ports directly to the mem bus
